<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Christoc.Themes.RhodopesTheme.Edit" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="RhodopesTheme" containersrc="Blank.ascx" />
